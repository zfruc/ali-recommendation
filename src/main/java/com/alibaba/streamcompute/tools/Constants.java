...
//  public static final String PD_ADDRESS = "127.0.0.1:2379";
  ...
  public static final boolean INDEX_ON = true;
  ...
  // If INDEX_ON is true, the key format of "click" is tablePrefix_rowPrefix_rowID, and we create a unique index on column user_id , a non-unique index on column flag.
  // else if INDEX_ON is false, the key format of "click" is tablePrefix_rowPrefix_userID_rowID, and we still create non-unique index on column flag, but the stored value
